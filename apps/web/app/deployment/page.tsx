import { eventsForProject, getMeridianStore, getProject, launchPreflight, readinessScore, walletsForGroup } from '../../lib/meridian-store';
...
function AllocationGraph({ project }: { project: ReturnType<typeof getMeridianStore>['projects'][number] }) {
  const items = [
      ...
      <div className="contentShell">
        <section className="documentHero oceanHero deploymentHero">
          ...
          <p>
            ...
            wallet readiness, funding plans, launch preflight, transaction builders, and post-launch monitoring. Funded execution remains live-gated.
          </p>
        </section>
