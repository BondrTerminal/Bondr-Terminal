    ...
    <section className="walletBoardShell">
      <header className="walletBoardHeader">
        ...
        <div className="walletBoardActions">
          ...
          <ActionButton onClick={() => openAction('create')} disabled={!MANAGED_LOCAL_WALLET_BETA_ENABLED} title="Disabled for browser-wallet beta">Create Local Wallet</ActionButton>
          <ActionButton onClick={() => openAction('import')} disabled={!MANAGED_LOCAL_WALLET_BETA_ENABLED} title="Disabled for browser-wallet beta">Import Local Wallet</ActionButton>
